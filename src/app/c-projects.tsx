    ...
    return (
        <section className="flex flex-col items-start gap-2 pb-4" aria-labelledby="projects-heading">
            <div className="flex justify-between items-center w-full">
                <h2 id="projects-heading" className="text-sm text-[#A3A3A3] pb-2.5">{dict.heading}</h2>
            </div>
            <div className="grid md:grid-cols-3 grid-rows-1 items-start w-full gap-x-24 gap-y-10" role="list" aria-label={dict.listLabel}>
